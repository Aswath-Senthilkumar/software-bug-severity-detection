...
def split_dataset():
    d4j = pd.read_csv('/Users/aswath/Downloads/Fall 2024/DM/Final Project/Code/d4j_methods_sc_metrics_comments.csv')
    new_d4j = categorical_to_number_d4j(d4j)
    bugs_jar = pd.read_csv('/Users/aswath/Downloads/Fall 2024/DM/Final Project/Code/bugsjar_methods_sc_metrics_comments.csv')
